...
export default function App() {
  ...
  const [todoData, setTodoData] = useState([
    createTodoTask('Completed task', 90, new Date('2024-03-05T13:24:00')),
    createTodoTask('Editing task', 90, new Date('2024-03-05T13:24:00')),
    createTodoTask('Active task', 90, new Date('2024-03-05T13:24:00')),
  ]);
